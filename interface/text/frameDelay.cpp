...
#define FRAMEDELAY
	...
	Set Position
	//--------------------------------------------*/
		void FrameDelay::setPos(vector p){
			pos[0] = p.x();
			pos[1] = p.y();
			pos[2] = p.z();
		}
	...
	Get Position
	//--------------------------------------------*/
		vector FrameDelay::getPos(){
			return vector((double)pos[0], (double)pos[1], (double)pos[2]);
		}

	/*--------------------------------------------//
	Set Color
	//--------------------------------------------*/
		void FrameDelay::setColor(vector p){
			color[0] = p.x();
			color[1] = p.y();
			color[2] = p.z();
		}
	...
	Get Color
	//--------------------------------------------*/
		vector FrameDelay::getColor(){
			return vector((double)color[0], (double)color[1], (double)color[2]);
		}
