...
all: 
	...
	@for file in $(deps); do object=`echo $$file | grep -oE "[a-zA-Z]*\.[cp]+" | grep -oE "^[a-zA-Z]*"`; object=`echo $$object.o`; if [[ ! -f $$object || $$file -nt $$object ]]; then echo -e "\t\t\tMaking $$object"; cflags=`echo $(CFLAGS) | tr : " "`; $(CC) $$cflags $$file -o $$object; fi; done
